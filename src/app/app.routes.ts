...
export const routes: Routes = [
    ...
    { path: 'quan-ly-thuoc', component: ThuocComponent, canActivate: [authGuard], data: { roles: ['ADMIN'] } },
    { path: 'quan-ly-kho-thuoc', component: KhoThuocComponent, canActivate: [authGuard], data: { roles: ['ADMIN', 'NHANVIEN'] } },
    { path: 'quan-ly-cam-an', component: CamComponent, canActivate: [authGuard], data: { roles: ['ADMIN'] } },
