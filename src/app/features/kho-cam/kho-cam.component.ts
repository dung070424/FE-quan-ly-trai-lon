...
@Component({
    ...
    templateUrl: './kho-cam.component.html',
    styleUrl: './kho-cam.component.scss'
})
export class KhoCamComponent implements OnInit {
    inventories: CamInventory[] = [];
    cams: Cam[] = [];
    searchTerm: string = '';
    ...
    loadInventories(): void {
        this.khoCamService.getAllInventory().subscribe({
            next: (data) => {
    ...
    saveImport(): void {
        ...
        this.khoCamService.importCam(payload).subscribe({
            next: (res) => {
                this.loadInventories();
    ...
    openExportModal(inventory: CamInventory): void {
    ...
    saveExport(): void {
        ...
        this.khoCamService.exportCam(this.currentExportInventory.id, amount).subscribe({
            next: (res) => {
                this.loadInventories();
    ...
    openHistoryModal(): void {
        this.khoCamService.getImportHistory().subscribe({
            next: (data) => {
